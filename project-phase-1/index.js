...
xhr.onload = (() => {
    if (xhr.status === 200) {
        ...
        if (document.URL == "http://127.0.0.1:5501/project-phase-1/touristpackages.html") {
        ...
        else if (document.URL == "http://127.0.0.1:5501/project-phase-1/localguides.html") {
        ...
        else if (document.URL == "http://127.0.0.1:5501/project-phase-1/travelplanner.html") {
...
// Form Validation
if (document.URL == "http://127.0.0.1:5501/project-phase-1/travelplannerrequest.html") {
