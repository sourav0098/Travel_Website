...
function  show(){
    ...
    if(nameError.innerHTML==""&&
       ...
       date2!==""){
    //name
    var nameElt = document.getElementById("username").value
    document.getElementById("name1").innerHTML = nameElt;
    //phone
   ...
   //destination
   var desElt = document.getElementById("des1").value;
   document.getElementById("des2").innerHTML= desElt;
    //time
